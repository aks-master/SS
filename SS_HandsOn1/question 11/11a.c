...
int main(int argc, char *argv[]) {
    ...
    // Using dup to duplicate file descriptor
    fd2 = dup(fd1);
    if (fd2 < 0) {
        perror("dup");
        close(fd1);
    ...
    append_to_file(fd1, "file question 11(A) normal FD\n");
    append_to_file(fd2, "file question 11(A) dup() FD\n");
...
file question 11(A) normal FD
file question 11(A) dup() FD
*/
