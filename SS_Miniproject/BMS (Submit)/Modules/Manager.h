    ...
    if (loginManager(connectionFD, mngID, password))
    {
        ...
        while (1)
        {
            ...
            case 4:
                ...
                goto label1; // so that we can ask for credentials
            case 5:
                // Logout
...
/*****funtion to handle manager login*****/
int loginManager(int connectionFD, int mngID, char *password)
{
    struct Employee mng;
...
/*****funtion to activate/ deactivate customer account*****/
void changeStatus(int connectionFD)
{
...
/*****funtion to assign loan application to  employee*****/
void assignLoanApplication(int connectionFD)
{
