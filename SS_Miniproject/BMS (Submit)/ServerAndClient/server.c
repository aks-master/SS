        ...
        else
        {
            ...
            else
            {
                ...
                default:
                    ...
                    bzero(readBuffer, sizeof(readBuffer));
                    write(connectionFileDescriptor, "Invalid Choice for server menu^", sizeof("Invalid Choice for server menu^"));
...
/*****function to handle client exit situation*****/
